...
export class AppComponent {
  ...
  public milestones = [
    ...
    { time      : 'May 2001',
      ...
      background: ''},
    { time      : 'Summer 2001',
      text      : 'Starred in the most popular music video on PoppTV with the band Útrás.',
      background: './assets/forum_alla_leid.jpg'},
    { time      : '2002',
      text      : 'Nominated for the FM957 Music Awards as "Best Newcomer" with the band, Útrás and climbed to 3rd place in the FM957 Music Charts.',
      background: ''},
    { time      : 'Summer 2003',
      text      : 'Had two popular songs on the radiostation, X-ið, with the band, Core Blooming.',
      background: ''},
    { time      : 'Fall of 2004',
    ...
    { time      : '2005 - 2006',
      text      : 'Lived in England and finished my Diploma in Audio Engineering. Realized how small the world is.',
      background: ''},
    { time      : 'January 2007',
    ...
    { time      : 'May 2016',
      text      : 'Got my BSc Degree with a 9.32 average grade.',
      background: ''},
    { time      : '2016 - 2017',
